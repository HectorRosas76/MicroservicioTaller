...
class ReservaRepository {
    ...
    //Aqui para abajo cosas de crear, modificar y borrar reservas, utilizando el controlador de reservas para realizar las operaciones,   //y devolviendo respuestas JSON con el resultado de la operación. Se manejan excepciones para errores comunes como datos faltantes o reserva no encontrada.
